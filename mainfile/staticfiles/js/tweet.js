document.addEventListener("DOMContentLoaded", () => {
  ...
  // Ensure media containers have proper dimensions
  document.querySelectorAll(".tweet-media-container").forEach((container) => {
    // Make sure all media containers maintain aspect ratio
  ...
  // Dummy adjustGridLayout function to prevent errors.  Replace with actual implementation if needed.
  function adjustGridLayout() {
    // Add your grid layout adjustment logic here
    console.log("adjustGridLayout function called")
  }
})
